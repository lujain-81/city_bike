...
<div class="column column2">
    ...
    border-radius: 6px;
}" class=" col-lg-4 col-md-4 col-10 mx-auto text-center" action="{{route('reset.password.post')}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="USER_EMAIL" readonly value="{{$resetPassword->EMAIL}}" id="inputEmail" class="form-control form-control-lg" placeholder="Email address" required="" autofocus="">
            </div>
            <div class="form-group">
