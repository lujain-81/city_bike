...
<div class="form-group {{ $errors->has('Salary') ? 'has-feedback has-error has-danger' : '' }}">
    <label for="exampleInputPassword5">Salary</label>
    {!! Form::text('Salary',  isset($item) ? $item->Salary : '',
                ['id' => 'Salary',
                'placeholder' => 'Salary',
...
<a href="{{route('panel.employees.index')}}" class="btn btn-light">Cancel</a>