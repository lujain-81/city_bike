    ...
    box-shadow: 0 0 6px 3px #b2b3b5;"  class="elementor-widget-wrap elementor-element-populated">
                        ...
                        <div class="elementor-widget-container">
                            <div class="qodef-shortcode qodef-m  qodef-qi-section-title  qodef-decoration--italic  qodef-link--underline-draw qodef-subtitle-icon--left">
                                <h2 class="qodef-m-title">
                                    <span class="qodef-e-colored">Login</span></h2>
                            </div>
                        </div>
                    </div>
                    <div class="elementor-element elementor-element-dc6b49d elementor-button-align-stretch elementor-widget elementor-widget-form" data-id="dc6b49d" data-element_type="widget" data-settings="{&quot;step_next_label&quot;:&quot;Next&quot;,&quot;step_previous_label&quot;:&quot;Previous&quot;,&quot;step_type&quot;:&quot;number&quot;,&quot;button_width&quot;:&quot;100&quot;,&quot;step_icon_shape&quot;:&quot;circle&quot;}" data-widget_type="form.default">
                        <div class="elementor-widget-container">
                            ...
                            <form class="" method="post" name="Booking Form" action="{{route('user.login.post')}}">
                            @csrf
                            <div class="elementor-form-fields-wrapper elementor-labels-above">
                                ...
                                <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-pickupLocation elementor-col-100 elementor-field-required elementor-mark-required">
                                    <label for="form-field-pickupLocation" class="elementor-field-label">
                                        Email							</label>
                                    <input size="1" type="text" name="Email" value="{{old('Email')}}" id="form-field-pickupLocation" class="elementor-field elementor-size-xs  elementor-field-textual" required="required" aria-required="true">
                                ...
                                <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-pickupLocation elementor-col-100 elementor-field-required elementor-mark-required">
                                    <a href="{{route('user.forget')}}">Forgot your password ? no problem click here.</a>
                                </div>
