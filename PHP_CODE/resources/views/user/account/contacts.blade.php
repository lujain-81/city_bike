...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        <div class="col-md-8">
            <a href="{{route('user.account.contact.add')}}" class="btn btn-success mb-2" style="color: #FFF">
        ...
        @if(Session::has('flash_message'))
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->Message}}</td>
                    <td>
                        <a href="{{route('user.account.contact', $item->ContactID)}}" class="btn btn-info" style="color: #FFF">
